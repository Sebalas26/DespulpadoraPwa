...
export const INITIAL_ORDERS_SAMPLE = [
  {
    ...
    branchName: 'Planta Principal',
    clientId: 1,
    clientName: 'Restaurante El Portal del Valle',
    clientPhone: '315 456 7890',
    clientAddress: 'Calle 45 # 12-30, Cali',
    status: 'DELIVERED' as const,
    orderDate: '2026-03-11',
    totalAmount: 184000,
    isPaid: true,
    paymentMethodName: 'Transferencia Bancolombia',
    notes: 'Entregar antes de las 11:00 AM',
  ...
  },
  {
    ...
    branchName: 'Planta Principal',
    clientId: 2,
    clientName: 'Frutería y Helados Doña Luz',
    clientPhone: '310 987 6543',
    clientAddress: 'Cra 8 # 15-40, Palmira',
    status: 'DISPATCHED' as const,
    orderDate: '2026-03-12',
    totalAmount: 126400,
    isPaid: false,
    paymentMethodName: 'Contra Entrega Efectivo',
    notes: 'Verificar sello térmico',
  ...
  },
  {
    ...
    branchName: 'Planta Principal',
    clientId: 3,
    clientName: 'Café & Panadería La Estación',
    clientPhone: '318 222 3344',
    clientAddress: 'Av 6N # 24-05, Cali',
    status: 'PICKING' as const,
    orderDate: '2026-03-12',
    totalAmount: 95500,
    isPaid: false,
    paymentMethodName: 'Nequi',
    notes: 'Pedido vía WhatsApp',
